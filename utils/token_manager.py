...
class TokenManager:
    ...
    def __init__(self, model_name: str = "claude-3-5-sonnet-20241022"):
        ...
        logger.info(f"TokenManager initialized for {model_name}: {self.context_limit} tokens available")
    ...
    def optimize_sources_for_context(self, search_results: List[Dict], 
                                   prompt_text: str) -> Tuple[List[Dict], TokenUsage]:
        ...
        sources_tokens = sum(self.estimate_tokens(self._format_single_source(src)) 
        ...
        logger.info(f"Token optimization complete: {usage.usage_percentage:.1f}% of context used")
        
        return optimized_sources, usage
    
    def _optimize_source_content(self, search_results: List[Dict], 
...
def create_token_manager(model_name: str = "claude-3-5-sonnet-20241022") -> TokenManager:
